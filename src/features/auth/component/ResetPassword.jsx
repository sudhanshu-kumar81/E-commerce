...
import { resetPasswordAsync } from '../../user/userSlice';
import { selectUserResetStatus,selectUserResetMessage } from '../../user/userSlice';
          ...
          >
            ...
            <div>
              ...
              <div className="mt-2">
                ...
                ):status==='rejected'?( <p className="text-red-500">{message}</p>):null}
              </div>
            </div>
            <div>
              <button
