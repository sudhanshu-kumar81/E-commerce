...
const sortHandler=(option)=>{
  ...
  return (
    <div className="bg-white">
      <div>
        <MobileFilter filterHandler={filterHandler} mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen} />
...
const MobileFilter=({mobileFiltersOpen,setMobileFiltersOpen,filterHandler})=>{
...
const DeskTopFilter=({filterHandler})=>{
